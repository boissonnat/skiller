...
Question.find_or_create_by(statement: 'What is Burn down?', right_answer: 'The sprint burn down chart is a publicly displayed chart showing remaining work in the sprint backlog. Updated every day, it gives a simple view of the sprint progress. It also provides quick visualizations for reference.', application_area: ApplicationArea.find_by(name: 'Scrum'))
